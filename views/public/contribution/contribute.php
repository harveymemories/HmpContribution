...
<p>As you share your experience with Hurricane Harvey, you may feel or remember painful emotions. You can stop sharing your story at any time. If you need additional assistance, consider contacting the following resources:</p>

<ul>
<li>Disaster Distress Helpline, 1-800-985-5990 (24 hours a day/ 7 days a week)</li>
<li>Red Cross, 713-526-8300 (M-F, 7:30 am to 5:30 pm)</li>
</ul>
...
<h2>Terms and Conditions</h2>
                <div class="inputs">
                <p class="explanation">By submitting an item, you agree that it may be published on the websites of the Harvey Memories Project and the <a href="https://www.houstonfloodmuseum.org" target="_blank">Houston Flood Museum</a>. You may also choose to attach an optional <a href="https://creativecommons.org/" target="_blank">Creative Commons</a> license to your item so that others can use and distribute it more easily. Check all the boxes that apply. For more information, see the full <?php echo __("<a href='" . contribution_contribute_url('terms') . "' target='_blank'>" . __('Terms and Conditions') . ".</a>"); ?></p>
